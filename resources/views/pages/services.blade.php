...
<head>
    ...
    @include('partials.seo', [
        'title' => ($locale === 'id' ? 'Layanan' : 'Services') . ' | ' . $site['brand']['name'],
        'description' =>
            $locale === 'id'
                ? 'Jelajahi layanan pengembangan perangkat lunak, AI kustom, infrastruktur cloud, dan konsultasi teknologi dari Nakala Digital.'
                : 'Explore our software development, custom AI, cloud infrastructure, and tech advisory services.',
    ])
                ...
                @forelse ($content['service_pillar_details'] ?? [] as $pillar)
                        ...
                        <div
                            ...
                            <ul class="space-y-3 font-label-sm text-label-sm text-primary uppercase tracking-wider">
                                <li class="flex items-center gap-2"><span
                                    ...
                                    {{ $locale === 'id' ? 'Kustomisasi Model AI' : 'Custom AI Model Development' }}
                                </li>
                                <li class="flex items-center gap-2"><span
                                        class="material-symbols-outlined scale-75">check_circle</span>
                                    {{ $locale === 'id' ? 'Otomasi Proses Bisnis' : 'Business Process Automation' }}
                                </li>
                                <li class="flex items-center gap-2"><span
                                        class="material-symbols-outlined scale-75">check_circle</span>
                        ...
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <ul
                                    ...
                                    <li class="flex items-center gap-2"><span
                                            class="material-symbols-outlined scale-75">check_circle</span>
                                        {{ $locale === 'id' ? 'Sistem Terukur' : 'Scalable Platform Architecture' }}
                                    </li>
                                    <li class="flex items-center gap-2"><span
                                            class="material-symbols-outlined scale-75">check_circle</span>
                    ...
                    @elseif ($idx === 4)
                        ...
                        <div
                            ...
                            <h3 class="font-headline-h3 text-headline-h3 mb-4">{{ $pillar['title'] ?? '' }}</h3>
                            <p class="font-body-md text-body-md text-on-surface-variant">{{ $pillar['body'] ?? '' }}
                            </p>
                        </div>
                    @elseif ($idx === 5)
                        <!-- 5. QA Governance -->
