                    ...
                    @forelse ($content['service_pillar_details'] ?? [] as $pillar)
                            ...
                            <div
                                ...
                                <ul class="space-y-3 font-label-sm text-label-sm text-primary uppercase tracking-wider">
                                    <li class="flex items-center gap-2"><span
                                            class="material-symbols-outlined scale-75">check_circle</span> LLM
                                        Customization
                                    </li>
                                    <li class="flex items-center gap-2"><span
                                            class="material-symbols-outlined scale-75">check_circle</span> Predictive
                                        Analytics</li>
                                    <li class="flex items-center gap-2"><span
                                            class="material-symbols-outlined scale-75">check_circle</span> AI Governance
                                    </li>
                                </ul>
                            </div>
                        @elseif ($idx === 2)
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    <h3 class="font-headline-h3 text-headline-h3 mb-4">{{ $pillar['title'] ?? '' }}
                                    </h3>
                        ...
                        @elseif ($idx === 4)
                            ...
                            <div
                                ...
                                <span class="material-symbols-outlined text-tertiary text-5xl mb-6"
                                    data-icon="web">web</span>
                                <h3 class="font-headline-h3 text-headline-h3 mb-4">{{ $pillar['title'] ?? '' }}</h3>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        <span
                                            class="px-4 py-2 bg-white border border-outline-variant font-label-sm text-label-sm rounded uppercase">{{ $locale === 'id' ? 'Dukungan L1/L2/L3' : 'L1/L2/L3 Support' }}</span>
                                        <span
                                            class="px-4 py-2 bg-white border border-outline-variant font-label-sm text-label-sm rounded uppercase">{{ $locale === 'id' ? 'Implementasi D365' : 'D365 Implementation' }}</span>
                                        <span
                                        ...
                                        <span
                                            class="px-4 py-2 bg-white border border-outline-variant font-label-sm text-label-sm rounded uppercase">{{ $locale === 'id' ? 'Pemantauan 24/7' : '24/7 Monitoring' }}</span>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="text-sm font-label-sm uppercase tracking-widest opacity-80">
                                        {{ $locale === 'id' ? 'SLA Terjamin' : 'SLA Guaranteed' }}</div>
                                </div>
                            </div>
                        @endif
                    @empty
        ...
        <section class="py-unit-lg bg-on-secondary-fixed">
            <div
                ...
                <div class="text-surface-variant font-label-sm text-label-sm uppercase tracking-widest">
                    {{ $locale === 'id' ? 'Mitra Kapabilitas Strategis' : 'Strategic Capability Partner' }}</div>
                <div class="bg-white/10 px-8 py-4 rounded-lg border border-white/20 flex items-center gap-4">
                    ...
                    <div class="text-xs text-white/60 font-body-md uppercase tracking-widest">
                        {{ $locale === 'id' ? 'Keunggulan Regional' : 'Regional Excellence' }}</div>
                </div>
                <div class="hidden md:block text-surface-variant font-body-md italic text-sm text-right">
                    {{ $locale === 'id' ? 'Menggabungkan wawasan Indonesia' : 'Combining Indonesian insight' }} <br />
                    {{ $locale === 'id' ? 'dengan standar teknologi Singapura.' : 'with Singaporean tech standards.' }}
                </div>
            </div>
        </section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    <div class="space-y-6">
                        ...
                        <p class="text-on-surface-variant">
                            {{ $locale === 'id' ? 'Membangun jaringan saraf tiruan proprietary yang disesuaikan dengan nuansa linguistik Indonesia dan pola perilaku konsumen.' : 'Building proprietary neural networks tailored to Indonesian linguistic nuances and consumer behavior patterns.' }}
                        </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <p class="text-on-surface-variant">
                            {{ $locale === 'id' ? 'Transisi mulus dari sistem monolitik ke microservices yang lincah tanpa mengganggu operasi lokal.' : 'Seamlessly transitioning monolithic systems to agile microservices without disrupting local operations.' }}
                        </p>
                        <img class="w-full rounded-lg"
