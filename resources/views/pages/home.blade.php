        ...
        <section
            ...
            <div
                ...
                <div class="space-y-unit-lg z-10">
                    <div
                        class="inline-flex items-center gap-2 bg-tertiary-fixed text-on-tertiary-fixed px-4 py-1.5 rounded-[20px] font-label-sm text-label-sm uppercase tracking-widest">
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        <div
                            class="inline-flex items-center gap-2 border border-outline-variant bg-surface-container px-4 py-2 rounded-[20px]">
                ...
                <div class="relative group">
                    <div
                        class="absolute -inset-4 bg-primary/10 rounded-[20px] blur-3xl opacity-50 group-hover:opacity-75 transition-opacity">
                    </div>
                    <img alt="AI Dashboard Visualization"
                        class="relative rounded-[20px] shadow-2xl border-4 border-surface-container-high w-full"
