...
<body class="overflow-x-hidden bg-surface text-on-surface">
    ...
    <main class="pt-20">
        ...
        <header id="company-hero"
            class="relative bg-gradient-to-br from-surface-container-lowest via-surface to-primary/5 border-b border-outline-variant overflow-hidden">
            ...
            <div
                ...
                <div class="relative mt-unit-lg md:mt-0 w-full h-[400px] flex items-center justify-center group"
                    id="premium-parallax-container" style="perspective: 1200px;">
                    <div
                        class="absolute -top-10 -right-10 w-72 h-72 bg-primary-fixed opacity-30 rounded-full blur-[80px] transition-all duration-700 group-hover:opacity-60 group-hover:scale-110">
                    </div>
                    ...
                    <div class="relative z-10 w-full h-full animate-[float_6s_ease-in-out_infinite]">
                        <img id="interactive-profile-img" alt="Digital Partnership Globe"
                            ...
                            src="{{ asset('assets/company_profile_hero.png') }}"
        ...
        <section id="vision-mission"
            class="py-unit-xl px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto scroll-mt-28">
            ...
            <section class="py-unit-xl bg-surface">
                <div class="px-margin-mobile md:px-8 lg:px-margin-desktop max-w-container-max mx-auto">
                    ...
                    <div class="relative max-w-3xl mx-auto">
                        <div class="absolute left-6 md:left-7 top-2 bottom-2 w-0.5 bg-outline-variant"
                            aria-hidden="true">
                        </div>
                    ...
                    <div class="bg-white rounded-[20px] shadow-sm border border-outline-variant p-unit-lg">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-unit-lg items-start">
                            ...
                            <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-unit-md">
                                <div
                                    class="bg-surface-container-low p-unit-md rounded-[20px] border-l-4 border-primary">
