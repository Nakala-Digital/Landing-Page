                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-unit-lg items-center">
                    <div>
                        ...
                        <p class="font-body-lg text-body-lg text-outline-variant mb-unit-lg max-w-xl">
                            Our systematic approach bridges local responsiveness with regional quality standards,
                            ensuring every technical milestone is backed by rigorous QA governance.
                        </p>
        ...
        <section class="py-unit-xl bg-surface">
            <div class="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
                <div class="mb-unit-lg text-center max-w-2xl mx-auto">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant">Seven critical stages of refinement to
                        ensure your digital product meets institutional standards from day one.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-unit-md">
                    ...
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-4">In-depth stakeholder workshops
                            to define product vision and technical feasibility.</p>
                        <div class="bg-surface p-2 rounded text-xs font-bold text-primary flex items-center gap-2">
                            <span class="material-symbols-outlined text-sm">description</span> Output: PRD &amp; Product
                            Roadmap
                        </div>
                    </div>
                    <!-- Step 2 -->
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-4">Resource allocation, sprint
                            scheduling, and architectural design patterns.</p>
                        <div class="bg-surface p-2 rounded text-xs font-bold text-primary flex items-center gap-2">
                            <span class="material-symbols-outlined text-sm">account_tree</span> Output: Technical Design
                            Doc
                        </div>
                    </div>
                    <!-- Step 3 -->
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-4">High-fidelity UI mockups and
                            UX prototyping with iterative feedback loops.</p>
                        <div class="bg-surface p-2 rounded text-xs font-bold text-primary flex items-center gap-2">
                    ...
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-4">Clean code execution using
                            industry-leading stacks and security best practices.</p>
                        <div class="bg-surface p-2 rounded text-xs font-bold text-primary flex items-center gap-2">
                    ...
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-4">Rigorous SIT and UAT phases to
                            identify and resolve blockers before launch.</p>
                        <div class="bg-surface p-2 rounded text-xs font-bold text-primary flex items-center gap-2">
                            <span class="material-symbols-outlined text-sm">bug_report</span> Output: QA &amp; SIT
                            Report
                        </div>
                    </div>
                    <!-- Step 6 -->
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-4">Phased rollout to production
                            environments with CI/CD automation.</p>
                        <div class="bg-surface p-2 rounded text-xs font-bold text-primary flex items-center gap-2">
                            <span class="material-symbols-outlined text-sm">rocket_launch</span> Output: Live Production
                            Site
                        </div>
                    </div>
                    <!-- Step 7 -->
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-4">Post-launch monitoring,
                            performance tuning, and ongoing feature updates based on real user data.</p>
                        <div class="bg-surface p-2 rounded text-xs font-bold text-primary flex items-center gap-2">
                            <span class="material-symbols-outlined text-sm">trending_up</span> Output: Optimization
                            Backlog
                        </div>
                    </div>
                </div>
        ...
        <section class="py-unit-xl bg-surface-container-low border-y border-outline-variant">
            <div class="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
                <div class="mb-unit-lg">
                    <h2 class="font-headline-h2 text-headline-h2 text-on-background">QA Governance &amp; Deliverables
                    </h2>
                    <p class="text-on-surface-variant max-w-xl">We don't just build; we certify. Every project follows a
                        strict governance framework that produces tangible technical artifacts.</p>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-gutter">
                    ...
                    <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-unit-md">
                        <div class="bg-white border-l-4 border-primary p-unit-md rounded shadow-sm">
                            ...
                            <p class="text-body-md text-on-surface-variant">Validation of functional and non-functional
                                requirements before development starts.</p>
                        </div>
                        <div class="bg-white border-l-4 border-primary p-unit-md rounded shadow-sm">
                            <div class="flex items-center gap-3 mb-2">
                            ...
                            <p class="text-body-md text-on-surface-variant">Strategic SIT (System Integration Testing)
                                and UAT (User Acceptance Testing) protocols.</p>
                        </div>
                        <div class="bg-white border-l-4 border-primary p-unit-md rounded shadow-sm">
                            <div class="flex items-center gap-3 mb-2">
                            ...
                            <p class="text-body-md text-on-surface-variant">Centralized tracking of issues with
                                priority-based resolution workflows.</p>
                        </div>
                        <div class="bg-white border-l-4 border-primary p-unit-md rounded shadow-sm">
                            <div class="flex items-center gap-3 mb-2">
                            ...
                            <p class="text-body-md text-on-surface-variant">Final certification and official handover
                                with complete operational documentation.</p>
                        </div>
                    </div>
                    <!-- Artifacts List -->
                    <div class="bg-on-background p-unit-md rounded-lg text-white">
                        <h4 class="font-headline-h3 text-headline-h3 mb-unit-md text-primary-fixed-dim">Project
                            Artifacts</h4>
                        <ul class="space-y-4">
        ...
        <section class="py-unit-lg bg-white border-b border-outline-variant">
            <div
                ...
                <div class="flex items-center gap-4">
                    <span class="text-on-surface-variant font-label-sm uppercase tracking-widest">Our Strategic
                        Partner</span>
