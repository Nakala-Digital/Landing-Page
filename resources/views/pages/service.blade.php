...
<p class="font-body-md text-body-md text-on-surface-variant mb-6">{{ app()->getLocale() === 'en' ? 'GenAI solutions for operational efficiency and automated customer engagement.' : 'Solusi GenAI untuk efisiensi operasional dan keterlibatan pelanggan otomatis.' }}</p>
...
<p class="font-body-md text-body-md text-surface-variant mb-6">{{ app()->getLocale() === 'en' ? 'Bespoke software tailored for unique business processes and high-performance requirements.' : 'Software khusus untuk proses bisnis unik dan kebutuhan performa tinggi.' }}</p>
...
<p class="font-body-md text-body-md text-on-surface-variant mb-6">{{ app()->getLocale() === 'en' ? 'Strategic advisory to align technology investments with business growth and market expansion.' : 'Advisory strategis untuk menyelaraskan investasi teknologi dengan pertumbuhan bisnis dan ekspansi pasar.' }}</p>
...
<p class="font-body-md text-body-md text-on-surface-variant">{{ app()->getLocale() === 'en' ? 'High-traffic portals and digital interfaces for B2B and B2C audiences.' : 'Portal trafik tinggi dan antarmuka digital untuk audiens B2B dan B2C.' }}</p>
</div>
<!-- 5. QA Governance -->
...
<p class="font-body-md text-body-md text-on-surface-variant">{{ app()->getLocale() === 'en' ? 'Zero-defect deployment through automated testing and rigorous quality standards.' : 'Deployment zero-defect melalui pengujian otomatis dan standar kualitas ketat.' }}</p>
</div>
...
<p class="font-body-lg text-body-lg text-on-surface-variant mb-6">{{ app()->getLocale() === 'en' ? 'End-to-end Microsoft D365 ecosystem management with 24/7 technical support.' : 'Manajemen ekosistem Microsoft D365 end-to-end dengan dukungan teknis 24/7.' }}</p>
