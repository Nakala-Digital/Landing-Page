                        ...
                        <form class="space-y-unit-md" id="contactForm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-unit-md">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <select
                                        class="w-full border-outline-variant rounded p-3 form-input-focus bg-surface-container-lowest">
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'Website / Portal' : 'Website / Portal' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'Mobile Application' : 'Aplikasi Mobile' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'AI / Automation Solution' : 'Solusi AI / Otomatisasi' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'Custom Business System' : 'Sistem Bisnis Kustom' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'QA / Software Testing' : 'QA / Pengujian Software' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'Other / Not Sure Yet' : 'Lainnya / Belum Yakin' }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-unit-md">
                                <div class="space-y-1">
                                    ...
                                    <select
                                        class="w-full border-outline-variant rounded p-3 form-input-focus bg-surface-container-lowest">
                                        <option>{{ app()->getLocale() === 'en' ? '< Rp 50 Million' : '< Rp 50 Juta' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'Rp 50 - 200 Million' : 'Rp 50 - 200 Juta' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'Rp 200 - 500 Million' : 'Rp 200 - 500 Juta' }}
                                        </option>
                                        <option>
                                            {{ app()->getLocale() === 'en' ? 'Rp 500 Million - 1 Billion' : 'Rp 500 Juta - 1 Miliar' }}
                                        </option>
                                        <option>{{ app()->getLocale() === 'en' ? '> Rp 1 Billion' : '> Rp 1 Miliar' }}
                                        </option>
