...
<head>
    ...
    <title>
        {{ $locale === 'en'
    ? 'University & Higher Education Digital Solutions | Nakala Digital'
    : 'Solusi Digital Perguruan Tinggi | Nakala Digital' }}
    </title>
    @include('partials.seo', [
        ...
        'description' =>
            $locale === 'en'
            ? 'Integrated digital solutions for universities and polytechnics: PMB, SIAKAD, e-learning, HRIS, tuition (UKT) payment, research & industry, and AI Assistant in one connected ecosystem.'
            : 'Solusi digital terintegrasi untuk universitas dan politeknik: PMB, SIAKAD, e-learning, HRIS, pembayaran UKT, riset & industri, hingga AI Assistant dalam satu ekosistem yang terhubung.',
    ])
                ...
                <div class="space-y-unit-lg z-10 pt-unit-lg lg:w-1/2">
                    ...
                    <div class="flex justify-start">
                        <div
                            ...
                            {{ $locale === 'en' ? 'Higher Education Solutions' : 'Solusi Perguruan Tinggi' }}
                        </div>
                    </div>
                    ...
                    <h1
                        ...
                        {!! $locale === 'en'
    ? 'Digital Ecosystem<br>for <span class="text-primary">Universities</span><br>and <span class="text-primary">Polytechnics</span>'
    : 'Ekosistem Digital<br>untuk <span class="text-primary">Universitas</span><br>dan <span class="text-primary">Politeknik</span>' !!}
                    </h1>
                    ...
                    <p
                        ...
                        {!! $locale === 'en'
    ? 'Manage complex academic ecosystems, research, to industry integration in one integrated platform that supports the student experience from admission to graduation.'
    : 'Kelola ekosistem akademik yang kompleks, riset, hingga integrasi industri dalam satu platform terintegrasi yang mendukung student experience dari admisi hingga kelulusan.' !!}
                    </p>
                </div>
            ...
            <div class="mx-auto w-full max-w-[1440px] px-margin-mobile md:px-margin-desktop">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-gutter justify-items-center">
                    ...
                    <div
                        ...
                        <ul class="grid grid-cols-1 gap-y-2 mt-unit-sm">
                            @php
                                $audiences = [
                                    ['id' => 'Rektorat & Pimpinan', 'en' => 'Rectorate & Leadership'],
                                    ['id' => 'Tim PMB/Admisi', 'en' => 'PMB/Admissions Team'],
                                    ['id' => 'Biro Administrasi Akademik', 'en' => 'Academic Administration Bureau'],
                                    ['id' => 'Tim Operasional & Keuangan Kampus', 'en' => 'Campus Operations & Finance Team'],
                                ];
                            @endphp
                    ...
                    {{-- Card 2: Fokus Utama (dark, same content) --}}
                    <div
                        ...
                        <div class="flex items-center gap-unit-md mb-unit-sm">
                            <div
                        ...
                        <div class="mt-unit-md space-y-unit-md">
                            <p class="font-body-md text-[16px] text-white/90 leading-snug">
                                {{ $locale === 'en'
    ? 'Optimizing New Student Admissions (PMB), improving integrated student experience quality, adaptive academic learning management, research ecosystem support, and synchronized management of complex institutions across faculties and study programs.'
    : 'Optimalisasi proses Penerimaan Mahasiswa Baru (PMB), peningkatan kualitas student experience terintegrasi, manajemen pembelajaran akademik yang adaptif, dukungan ekosistem riset, dan sinkronisasi pengelolaan institusi yang kompleks lintas fakultas dan program studi.' }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mx-auto w-full max-w-[1440px] px-margin-mobile md:px-margin-desktop">
                ...
                <div class="mb-unit-xl max-w-2xl mx-auto text-center">
                    ...
                    <h2
                        ...
                        {{ $locale === 'en' ? 'College Solutions Details' : 'Detail Solusi Perguruan Tinggi' }}
                    </h2>
                    <p class="font-body-lg text-body-lg text-on-surface-variant">
                        {{ $locale === 'en'
    ? 'Integrated modules designed to support every aspect of modern higher education management.'
    : 'Modul terintegrasi untuk mendukung setiap aspek manajemen perguruan tinggi modern.' }}
                    </p>
                </div>
                ...
                @php
                    $capabilities = [
                        [
                            'icon' => 'how_to_reg',
                            'title' => ['en' => 'PMB and Admission CRM', 'id' => 'PMB dan Admission CRM'],
                            'desc' => ['en' => 'Centralized online registration, smart lead tracking, and structured new student admission pipeline management for maximum conversion.', 'id' => 'Pendaftaran online tersentralisasi, pelacakan prospek cerdas, dan manajemen pipeline penerimaan mahasiswa baru yang terstruktur untuk konversi maksimal.'],
                        ],
                        [
                            'icon' => 'school',
                            'title' => ['en' => 'Student Experience Portal', 'id' => 'Student Experience Portal'],
                            'desc' => ['en' => 'A one-stop student services portal that facilitates academic needs from enrollment to graduation.', 'id' => 'Pusat layanan mahasiswa satu pintu yang memfasilitasi kebutuhan akademik hingga kelulusan.'],
                        ],
                        [
                            'icon' => 'menu_book',
                            'title' => ['en' => 'LMS & SIAKAD Integration', 'id' => 'LMS & SIAKAD Integration'],
                            'desc' => ['en' => 'Seamless integration between the academic information system (SIAKAD) and the learning platform (LMS).', 'id' => 'Integrasi mulus antara sistem informasi akademik (SIAKAD) dengan platform pembelajaran (LMS).'],
                        ],
                        [
                            'icon' => 'payments',
                            'title' => ['en' => 'UKT / Payment Service', 'id' => 'UKT / Payment Service'],
                            'desc' => ['en' => 'Automated tuition (UKT) billing and easy access to various digital payment channels.', 'id' => 'Otomatisasi pembuatan tagihan UKT dan kemudahan akses ke berbagai saluran pembayaran digital.'],
                        ],
                        [
                            'icon' => 'badge',
                            'title' => ['en' => 'HRIS & Operations', 'id' => 'HRS & Operasional'],
                            'desc' => ['en' => 'Integrated management of lecturer and staff human resources to support efficient daily campus operations.', 'id' => 'Manajemen terpadu SDM dosen dan staf untuk mendukung efisiensi operasional harian kampus.'],
                        ],
                        [
                            'icon' => 'science',
                            'title' => ['en' => 'Career & Assessment', 'id' => 'Career & Assessment'],
                            'desc' => ['en' => 'Comprehensive support for student career paths and learning outcome evaluation based on industry competency maps.', 'id' => 'Dukungan komprehensif untuk jalur karir mahasiswa dan evaluasi hasil belajar berbasis peta kompetensi industri.'],
                        ],
                        [
                            'icon' => 'smart_toy',
                            'title' => ['en' => 'AI Parent / Management Assistant', 'id' => 'AI Parent / Management Assistant'],
                            'desc' => ['en' => '24/7 information assistance for parents and prospective students, from admission status to bills, with automatic escalation to admin staff for more complex questions.', 'id' => 'Bantuan informasi 24/7 untuk orang tua dan calon Mahasiswa mulai dari status pendaftaran hingga tagihan dengan eskalasi otomatis ke staf admin untuk pertanyaan yang lebih kompleks.'],
                        ],
                        [
                            'icon' => 'forum',
