...
>>>>>>> a66a9cf7b758d2a0cba1ee6c01dceb6dbebafded
            ...
            <button
                class="bg-primary text-on-primary w-full py-unit-md rounded-lg font-button text-button mt-auto">{{ app()->getLocale() === 'en' ? 'Discuss Project' : 'Diskusikan Proyek' }}</button>
        </div>
    </div>
    <script>
