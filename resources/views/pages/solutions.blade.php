...
<body class="bg-background text-on-background font-body-md">
    ...
    <main class="pt-20">
        ...
        'summary' => [
        'en' => 'An AI-based recruitment platform that helps screen candidates, speed up the selection process, schedule
        ...
        'id' => 'Tim rekrutmen menghadapi volume CV tinggi, screening tidak konsisten, dan time-to-hire lambat sehingga
        ...
        'features' => [
        'en' => ['AI CV parsing and scoring', 'Job-fit ranking and automated shortlisting', 'Interview scheduling and
        ...
        'challenge' => [
        'en' => 'HR teams manage attendance, leave, payroll, and employee data manually across spreadsheets without a
        centralized system.',
        'id' => 'Tim HR mengelola absensi, cuti, payroll, dan data karyawan secara manual di banyak spreadsheet tanpa
        sistem terpusat.',
        ],
        'solution' => [
        ...
        'features' => [
        'en' => ['Attendance and leave management', 'Payroll processing and employee profiles', 'Approval workflows and
        reporting dashboard', 'Mobile-friendly interface'],
        'id' => ['Manajemen absensi dan cuti', 'Proses payroll dan profil karyawan', 'Approval workflow dan dashboard
        ...
        'id' => ['Data HR terpusat dengan visibilitas real-time', 'Proses manual HR berkurang signifikan', 'Pengalaman
        ...
        'id' => 'Platform digital untuk pelaporan insiden, safety checklist, dashboard kepatuhan, alert, audit trail,
        dan akses berbasis role.',
        ],
        'challenge' => [
        'en' => 'HSE compliance and safety reporting rely on manual forms, spreadsheets, and disconnected communication
        channels.',
        ...
        'solution' => [
        'en' => 'A dedicated HSE operations platform enabling digital incident reporting, safety checklist management,
        and compliance tracking.',
        'id' => 'Platform operasional HSE khusus untuk pelaporan insiden digital, manajemen safety checklist, dan
        tracking kepatuhan.',
        ],
        'features' => [
        'en' => ['Incident reporting and tracking', 'Safety checklist management', 'Compliance dashboard and real-time
        ...
        management', 'Reduced risk of unreported safety incidents', 'Audit-ready documentation and reporting trail'],
        'id' => ['Respons insiden lebih cepat lewat pelaporan real-time', 'Visibilitas kepatuhan HSE lebih baik untuk
        ...
        'id' => 'Platform manajemen kas digital untuk lingkungan hunian dengan billing, tracking pembayaran, dashboard
        finansial, dan portal warga.',
        ],
        'challenge' => [
        'en' => 'Residential communities manage monthly dues, facility fees, and cash flow through manual collection and
        informal records.',
        ...
        visibility.',
        'id' => 'Wargakas menghadirkan billing transparan, tracking pembayaran, laporan finansial, dan visibilitas untuk
        warga.',
        ],
        'features' => [
        ...
        'id' => ['Billing dan invoice warga', 'Tracking pembayaran dan manajemen pengeluaran', 'Dashboard finansial',
        'Portal warga dan laporan admin'],
        ],
        'impact' => [
        'en' => ['Transparent and auditable community finance', 'Reduced manual collection effort', 'Improved resident
        trust through real-time visibility', 'Scalable for multiple residential clusters'],
        'id' => ['Keuangan komunitas lebih transparan dan auditable', 'Beban penagihan manual berkurang', 'Kepercayaan
        ...
        'summary' => [
        'en' => 'End-to-end school admission and portal solution with online registration, document upload, verification
        ...
        'challenge' => [
        'en' => 'Educational institutions still rely on manual paper-based admission processes, reducing transparency
        and parent experience during PPDB season.',
        'id' => 'Institusi pendidikan masih mengandalkan proses penerimaan manual berbasis kertas, sehingga transparansi
        ...
        'id' => ['Proses penerimaan lebih terstruktur dan auditable', 'Pengalaman orang tua membaik lewat transparansi',
        ...
        'summary' => [
        'en' => 'AI-powered coaching platform for personalized learning journeys, goal tracking, progress dashboards,
        and on-demand conversational coaching.',
        'id' => 'Platform coaching berbasis AI untuk learning journey personal, tracking target, dashboard progres, dan
        coaching percakapan on-demand.',
        ],
        'challenge' => [
        'en' => 'Organizations struggle to deliver consistent and scalable coaching for distributed teams where human
        coach access is limited or costly.',
        'id' => 'Organisasi sulit menghadirkan coaching yang konsisten dan skalabel untuk tim tersebar saat akses coach
        ...
        'id' => 'Menghadirkan learning journey personal dan interaksi coaching melalui conversational AI serta tracking
        performa.',
        ],
        'features' => [
        'en' => ['AI coaching chatbot', 'Personalized learning paths', 'Goal setting and progress dashboards', 'Manager
        ...
        'impact' => [
        'en' => ['Scalable coaching without proportional cost increase', 'Personalized development for each employee',
        ...
        'features' => [
        'en' => ['D365 Finance module support', 'Power BI reporting integration', 'Power Automate workflow automation',
        ...
        capability and local business needs', 'Flexible project-based or retainer engagement', 'Delivered with Romulus
        ...
        enterprise dengan kebutuhan bisnis lokal', 'Fleksibel untuk project-based atau retainer', 'Didukung expertise
        ...
        'summary' => [
        'en' => 'AI-enabled solutions for GenAI applications, document intelligence, intelligent automation, dashboard
        ...
        'challenge' => [
        'en' => 'Organizations need to automate repetitive tasks, enhance decision-making, and embed intelligence into
        daily operations.',
        'id' => 'Organisasi perlu mengotomasi pekerjaan repetitif, meningkatkan pengambilan keputusan, dan menanamkan
        intelligence ke operasional harian.',
        ],
        'solution' => [
        'en' => 'Design and deploy GenAI workflows, AI-assisted operations, data pipelines, dashboards, and B2B AI SaaS
        platforms.',
        'id' => 'Merancang dan membangun workflow GenAI, operasi berbantuan AI, data pipeline, dashboard, dan platform
        AI SaaS B2B.',
        ],
        'features' => [
        'en' => ['Conversational AI and document intelligence', 'Intelligent automation and smart notifications', 'AI
