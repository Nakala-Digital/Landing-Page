                ...
                <div class="space-y-unit-md z-10">
                    ...
                    <div class="pt-unit-md">
                        <a href="{{ route('contact' . (app()->getLocale() === 'en' ? '.en' : '')) }}"
                            ...
                            {{ app()->getLocale() === 'en' ? 'Start Free Consultation' : 'Mulai Konsultasi Gratis' }}======={{ app()->getLocale() === 'en' ? 'Consult Your Needs' : 'Konsultasikan Kebutuhan Anda' }}>
                ...
                <div
                    ...
                    <div class="space-y-unit-md">
                        ...
                        <p class="font-body-md text-body-md opacity-90">
                            ...
                            @else
                            Menjadi mitra teknologi strategis yang menghasilkan solusi digital <strong>
                                profesional, bermakna, dan berdampak</strong> bagi pertumbuhan organisasi di
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4 mb-unit-md">
                            ...
                            <h4 class="font-headline-h3 text-headline-h3 m-0">
                                {{ app()->getLocale() === 'en' ? 'AI-Based Mindset' : 'Pola Pikir Berbasis AI' }}
                            </h4>
                        </div>
                        <p class="text-on-surface-variant font-body-md text-body-md leading-relaxed">
                            {{ app()->getLocale() === 'en'
