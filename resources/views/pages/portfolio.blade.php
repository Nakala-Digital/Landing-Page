            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
                ...
                <div
                    ...
                    <div class="flex justify-between items-start mb-unit-lg">
                        ...
                        <span
                            class="bg-tertiary-fixed text-on-tertiary-fixed px-unit-md py-1 rounded-full font-label-sm uppercase shrink-0 ml-unit-sm">{{ app()->getLocale() === 'en' ? 'AI Powered' : 'Didukung AI' }}</span>
                    </div>
                    <p class="text-on-surface-variant text-body-md mb-unit-lg">
