        ...
        <section class="py-unit-xl px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
                ...
                <div
                    ...
                    <span
                        class="bg-primary px-unit-md py-1 rounded-full font-label-sm text-white uppercase tracking-widest">{{ app()->getLocale() === 'en' ? 'Industrial' : 'Industri' }}</span>
                    ...
                    <a href="{{ route('contact' . (app()->getLocale() === 'en' ? '.en' : '')) }}?project=hse-safety-tracker"
                        class="mt-auto text-tertiary font-button flex items-center gap-unit-xs group-hover:gap-unit-sm transition-all w-fit">{{ app()->getLocale() === 'en' ? 'View Details' : 'Lihat Detail' }}
                        <span class="material-symbols-outlined text-lg">arrow_forward</span></a>
                </div>
                <!-- 4. WargaKas -->
                <div
                    ...
                    <div class="flex flex-col md:flex-row-reverse h-full">
                        <div class="w-full md:w-1/2 p-unit-lg flex flex-col justify-between">
                            <div>
                                <span
                                    class="inline-flex items-center gap-1 font-label-sm text-label-sm text-tertiary-fixed-dim uppercase tracking-widest bg-tertiary-fixed/20 px-unit-sm py-1 rounded-full mb-unit-md">{{ app()->getLocale() === 'en' ? 'Community Fintech' : 'Fintech Komunitas' }}</span>
                ...
                <div
                    ...
                    <div class="flex justify-between items-start mb-unit-lg">
                        ...
                        <span
                            class="bg-tertiary-fixed text-on-tertiary-fixed px-unit-md py-1 rounded-full font-label-sm uppercase shrink-0 ml-unit-sm">AI
                            Powered</span>
                    </div>
                    <p class="text-on-surface-variant text-body-md mb-unit-lg">
                    ...
                    <a href="{{ route('contact' . (app()->getLocale() === 'en' ? '.en' : '')) }}?project=ai-hiring-assistant"
                        class="mt-auto text-primary font-button flex items-center gap-unit-xs group-hover:gap-unit-sm transition-all w-fit">{{ app()->getLocale() === 'en' ? 'View Details' : 'Lihat Detail' }}
                        <span class="material-symbols-outlined text-lg">arrow_forward</span></a>
                </div>
                <!-- 6. AI Coach -->
                <div
                    ...
                    <div class="mb-unit-xl text-center md:text-left relative z-10">
                        ...
                        <p class="text-on-surface-variant text-body-md mb-unit-md">
                            {{ app()->getLocale() === 'en' ? 'AI-based adaptive learning to help companies upskill teams more effectively.' : 'Pembelajaran adaptif berbasis AI untuk membantu perusahaan meningkatkan keterampilan tim secara lebih efektif.' }}
                        </p>
                ...
                <div
                    ...
                    <p class="text-on-surface-variant text-body-md mb-unit-lg">
                        {{ app()->getLocale() === 'en' ? 'Integrate data from legacy systems into Microsoft Dynamics 365 to support more integrated business operations.' : 'Mengintegrasikan data dari sistem lama ke Microsoft Dynamics 365 untuk mendukung operasional bisnis yang lebih terintegrasi.' }}
                    </p>
                    <div class="bg-surface-container p-unit-md rounded-lg border border-outline-variant mb-unit-md">
                ...
                <div
                    ...
                    <div class="flex-1 order-2 md:order-1">
                        <span
                            class="inline-flex items-center gap-1 font-label-sm text-label-sm text-primary uppercase tracking-widest bg-primary/10 px-unit-sm py-1 rounded-full mb-unit-md">{{ app()->getLocale() === 'en' ? 'Retail & Commerce' : 'Ritel & Komersial' }}</span>
                        <h3 class="font-headline-h3 text-headline-h3 mb-unit-md">360° Customer Engagement</h3>
                        <p class="text-on-surface-variant text-body-md mb-unit-md">
                            {{ app()->getLocale() === 'en' ? 'an integrated dashboard that connects online sales, social media insights, and physical store activity to support a more effective marketing strategy.' : 'Dasbor terpadu yang menghubungkan penjualan online, insight media sosial, dan aktivitas toko fisik untuk mendukung strategi pemasaran yang lebih efektif.' }}
                        </p>
                        <div class="flex flex-wrap gap-unit-sm mb-unit-md">
                            <span
                                class="px-unit-sm py-1 bg-surface-variant text-on-surface-variant text-label-sm rounded-full">{{ app()->getLocale() === 'en' ? 'Omnichannel' : 'Omnichannel' }}</span>
                            <span
                                class="px-unit-sm py-1 bg-surface-variant text-on-surface-variant text-label-sm rounded-full">{{ app()->getLocale() === 'en' ? 'Sentiment Analysis' : 'Analisis Sentimen' }}</span>
                            <span
                                class="px-unit-sm py-1 bg-surface-variant text-on-surface-variant text-label-sm rounded-full">{{ app()->getLocale() === 'en' ? 'Predictive Analytics' : 'Analitik Prediktif' }}</span>
                        </div>
