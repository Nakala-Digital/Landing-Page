...
<body class="bg-background text-on-background font-body-md">
    ...
    <main class="pt-20">
        ...
        <section id="hero"
            ...
            <!-- Glow Blobs -->
            <div class="absolute -top-[20%] -left-[10%] w-[500px] h-[500px] rounded-full bg-primary/10 blur-[120px]">
            </div>
            <div
                class="absolute top-[30%] -right-[10%] w-[400px] h-[400px] rounded-full bg-tertiary-fixed/10 blur-[100px]">
            </div>
            ...
            <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-unit-xl items-center relative">
                    ...
                    <div class="lg:col-span-6 relative z-20">
                        <div
                            class="inline-flex items-center gap-2 bg-tertiary-fixed text-on-tertiary-fixed px-unit-md py-2 rounded-lg font-label-sm text-label-sm uppercase tracking-widest mb-unit-md shadow-lg shadow-tertiary-fixed/20">
                            <span class="material-symbols-outlined text-[18px]">{{ $case['icon'] }}</span>
                            {{ $case['category'][$locale] }}
                        </div>

                        <h1
                            class="font-headline-h1 text-4xl md:text-headline-h1 md:text-[52px] md:leading-[1.1] text-on-background leading-tight mb-unit-md">
                            {{ $case['title'][$locale] }}
                        </h1>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-unit-md mt-8">
                            <!-- Card 1 -->
                            <div
                                class="border-l-4 border-primary bg-white/70 backdrop-blur-md p-unit-md rounded-xl shadow-lg shadow-primary/5 border-t border-r border-b border-white/50 relative overflow-hidden group hover:bg-white/90 transition-all duration-300">
                                <p
                                    class="text-xs font-bold uppercase tracking-widest text-primary mb-unit-sm relative z-10">
                            ...
                            <!-- Card 2 -->
                            <div
                                class="border-l-4 border-tertiary-fixed bg-white/70 backdrop-blur-md p-unit-md rounded-xl shadow-lg shadow-tertiary-fixed/5 border-t border-r border-b border-white/50 relative overflow-hidden group hover:bg-white/90 transition-all duration-300">
                                <p
                                    class="text-xs font-bold uppercase tracking-widest text-primary mb-unit-sm relative z-10">
                    ...
                    <div class="lg:col-span-6 relative z-10 hidden lg:block h-[550px]" id="hero-mockup-container"
                        style="perspective: 1000px;">
                        <div class="absolute inset-0 transition-transform duration-300 ease-out"
                            id="hero-mockup-wrapper">

                            <!-- Main Image (Back Layer) -->
                            <div class="absolute top-[10%] -right-[5%] w-[100%] rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-outline-variant/30 animate-float-slow hover:-translate-y-2 transition-all duration-500 bg-white"
                                style="will-change: transform;">
                                <!-- Browser Window Dots -->
                                <div
                                    class="h-8 bg-surface-container-lowest border-b border-outline-variant/50 flex items-center px-4 gap-2">
                                    <div class="w-2.5 h-2.5 rounded-full bg-[#FF5F56]"></div>
                                    <div class="w-2.5 h-2.5 rounded-full bg-[#FFBD2E]"></div>
                                    <div class="w-2.5 h-2.5 rounded-full bg-[#27C93F]"></div>
                                </div>
                                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=100&w=2000&auto=format&fit=crop"
                                    class="w-full h-auto object-cover" alt="Dashboard Mockup">
                            </div>

                            <!-- Secondary Widget (Floating Middle Left) -->
                            <div
                                class="absolute top-[35%] -left-[10%] w-[45%] rounded-xl overflow-hidden shadow-2xl border border-outline-variant/40 animate-float-fast hover:scale-105 transition-transform duration-300 bg-white z-20">
                                <!-- Another browser header for consistency -->
                                <div
                                    class="h-6 bg-surface-container-lowest border-b border-outline-variant/50 flex items-center px-3 gap-1.5">
                                    <div class="w-2 h-2 rounded-full bg-outline-variant"></div>
                                    <div class="w-2 h-2 rounded-full bg-outline-variant"></div>
                                </div>
                                <img src="https://images.unsplash.com/photo-1543286386-713bdd548da4?q=80&w=800&auto=format&fit=crop"
                                    class="w-full h-auto object-cover" alt="Analytics Widget">
                            </div>

                            <!-- Tertiary Widget/Badge (Floating Bottom Right) -->
                            <div class="absolute -bottom-[5%] right-[10%] w-[50%] z-30 bg-white p-5 rounded-2xl shadow-2xl border border-outline-variant/20 flex items-center gap-4 animate-float-slow hover:shadow-primary/20 transition-all duration-300"
                                style="animation-delay: -2.5s;">
                                <div
                                    class="w-12 h-12 rounded-full bg-tertiary-fixed flex items-center justify-center shrink-0">
                                    <span
                                        class="material-symbols-outlined text-on-tertiary-fixed text-[24px]">trending_up</span>
                                </div>
                                <div>
                                    ...
                                    <div class="flex items-end gap-2">
                                        ...
                                        <span
                                            class="text-[10px] font-bold text-green-600 bg-green-100 px-2 py-0.5 rounded-full">Boost</span>
                                    </div>
                                </div>
                            </div>

                            <!-- Sparkle Decorative Element -->
                            <div class="absolute top-[5%] right-[80%] text-primary animate-float-fast"
