...
<header
    ...
    <nav
        ...
        <div class="hidden lg:flex items-center justify-center gap-6 xl:gap-8 flex-1">
            ...
            <<<<<<< HEAD @php $active=request()->routeIs($item['route'] . $localeSuffix) ||
...
=======
            ...
            ($item['route'] === 'services' && request()->routeIs('service' . $localeSuffix));
            @endphp
            <a class=" relative whitespace-nowrap font-button text-button uppercase tracking-wide xl:tracking-wider
                    transition-colors pb-0.5>>>>>>> 2803b4f (Hacker-Style Wording, Validate Brand Color,Why Nakala)
                    {{ $active
        ...
        <div class="flex items-center justify-end gap-3 xl:gap-4 shrink-0">
            ...
            <div <<<<<<< HEAD
                ...
                =======
                class="hidden md:flex items-center bg-tertiary text-secondary rounded-lg px-3 py-2 text-sm font-button
                tracking-wider uppercase shadow-sm transition-colors hover:opacity-90">
                ...
                <div class="absolute right-0 mt-3 w-56 rounded-xl bg-white shadow-lg ring-1 ring-black/5 p-2">
                    ...
                    <div class="mt-2 pt-2 border-t border-slate-100 flex items-center justify-between p-2">
                        ...
                        <div <<<<<<< HEAD
                            ...
                            =======
                            class="flex items-center bg-tertiary text-secondary rounded-lg px-3 py-1.5 text-sm
                            font-button tracking-wider uppercase shadow-sm">
                            >>>>>>> 2803b4f (Hacker-Style Wording, Validate Brand Color,Why Nakala)
                            <a href="{{ $locale === 'id' ? '#' : $targetUrl }}"
                                class="{{ $locale === 'id' ? 'font-bold' : 'opacity-70 hover:opacity-100 transition-opacity' }}">ID</a>
                            <span class="mx-2 opacity-40">|</span>
